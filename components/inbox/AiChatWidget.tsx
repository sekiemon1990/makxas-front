...
export function AiChatWidget({
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 md:bottom-6 md:right-6">
      {open ? (
        <div className="flex h-[480px] w-[360px] flex-col rounded-2xl border border-zinc-200 bg-white shadow-2xl">
          {/* ヘッダー */}
          ...
          <div className="border-t border-zinc-200 p-3">
            <div className="flex gap-2">
              <Textarea
                className="min-h-0 h-9 resize-none bg-white text-xs leading-5 py-2"
